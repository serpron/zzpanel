...
public class Page<T> {
    ...
    private Integer start=0;  // 当前页起始位置
    private Integer rows = 3;   // 一页记录数
    private List<T> list=new ArrayList<>(); // 一页数据
    private Integer page=1;  // 当前页
    private Integer prev=0;  // 上一页
    private Integer next=2;  // 下一页
    private Integer startPage=1; //起始页
    private Integer endPage;   //截止页
    private Integer pages=10;   // 页码数
