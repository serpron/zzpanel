...
layui.define(["layer", "laytpl", "utils", "lodash"], function(i) {
    var e = layui.jquery,
        ...
        r = ['<div class="kit-sidebar" style="{{d.direction}}:-{{d.width}};width:{{d.width}};" kit-sidebar="{{d.id}}">', '<div class="kit-sidebar-body">', '  <div class="layui-card">', '    <div class="layui-card-header">', '      <span class="nowrap" title="{{d.title}}">{{d.title}}</span>', '      <div class="kit-sidebar-reload" title="刷新">', '        <i class="layui-icon">&#xe669;</i>', "      </div>", '      <div class="kit-sidebar-close" title="关闭">', '        <i class="layui-icon">&#x1006;</i>', "      </div>", "    </div>", '    <div class="layui-card-body">', "      {{d.content}}", "    </div>", "  </div>", "</div>", "</div>"].join(""),
        l = ['<div class="kit-sidebar-loading layui-anim layui-anim-fadein">', "    <div>", '        <i class="layui-icon layui-anim layui-anim-rotate layui-anim-loop">&#xe63e;</i>', "    </div>", "</div>"];
