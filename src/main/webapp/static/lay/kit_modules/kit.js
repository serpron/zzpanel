...
"use strict";
layui.define(["layer", "utils"], function(t) {
    var i = layui.jquery,
        a = i(window);
    ...
    var e = {
        toolsInit: function() {
            ...
            t.on("click", function() {
                var a = i("div[kit-side]"),
                    s = i("div[kit-body]"),
                    e = i("div[kit-tabs-t]"),
                    l = i("div[kit-footer]");
                switch (t.attr("data-toggle")) {
                    case "on":
                        a.animate({
                            width: "0px"
                        }), s.animate({
                            ...
                            left: "0"
                        }), i(this).attr("data-toggle", "off"), t.find("i.layui-icon").html("&#xe65b;");
                        break;
                    case "off":
                        a.animate({
                            width: "200px"
